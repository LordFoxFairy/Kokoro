...
- [ ] E2 (agent runtime): `run_agent` builds `create_deep_agent` and streams `astream_events`, mapping events → AgentEvent. Add a scripted tool-calling fake model for local/tests.
