...
const PUBLIC_OPERATIONS = new Map([
  ...
  ["listMemoryEntryHistory", ["get", "/v1/memory/entries/{entryRef}/history"]],
  ["restoreMemoryEntryRevision", ["post", "/v1/memory/entries/{entryRef}/history/{revisionRef}:restore"]],
  ["correctMemoryEntry", ["post", "/v1/memory/entries/{entryRef}:correct"]],
  ["deprioritizeMemoryEntry", ["post", "/v1/memory/entries/{entryRef}:deprioritize"]],
  ["forgetMemoryEntry", ["post", "/v1/memory/entries/{entryRef}:forget"]],
  ["prioritizeMemoryEntry", ["post", "/v1/memory/entries/{entryRef}:prioritize"]],
...
const ADMISSION_SHA256 = "3e4091cde7ace9f08bb4c0a507471a8a975878e8ad5c5b2038c5b278040c1cca";
