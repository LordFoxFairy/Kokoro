...
(
  ...
  KOKORO_BFF_MODE=live KOKORO_BFF_POSTGRES_URL="$BFF_DATABASE_URL" KOKORO_BFF_REDIS_URL="$BFF_REDIS_URL" pnpm lint
  KOKORO_BFF_MODE=live KOKORO_BFF_POSTGRES_URL="$BFF_DATABASE_URL" KOKORO_BFF_REDIS_URL="$BFF_REDIS_URL" pnpm typecheck
  pnpm contract:check
  KOKORO_BFF_MODE=live KOKORO_BFF_POSTGRES_URL="$BFF_DATABASE_URL" KOKORO_BFF_REDIS_URL="$BFF_REDIS_URL" pnpm test
