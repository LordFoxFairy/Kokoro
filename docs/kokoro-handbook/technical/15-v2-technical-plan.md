...
- 落地更新（2026-07）：**G1 鉴权 / G2 失败码 / G4 i18n 已落地**。失败呈现（§1.2③）已修为按码讲人话；web 静态 i18n（中/英，`kokoro-web/src/i18n`）已上线；身份签发+验签链与登录闸已落地，浏览器密封 cookie 形态见 [AUTH-P0](../../superpowers/specs/2026-07-12-wave1-auth-p0.md)（在办）。以下正文维持 2026-07-05 原文。
