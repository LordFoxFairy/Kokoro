...
2. [`CODEBASE_MAP.md`](CODEBASE_MAP.md)：十个 active repository 的 owner、目录、运行链路和派工上下文。
...
| 任务 | 入口 |
| --- | --- |
| 了解十仓边界 | [`CODEBASE_MAP.md`](CODEBASE_MAP.md)、[`REPOSITORY_STATUS.md`](REPOSITORY_STATUS.md) |
...
| 执行质量门禁 | [`../scripts/INDEX.md`](../scripts/INDEX.md)、[`../scripts/verify-ten-repository-full.sh`](../scripts/verify-ten-repository-full.sh) |
