...
| kokoro-bff | LordFoxFairy/kokoro-bff | Chat、业务 BFF、Project/Task/ScheduledTask、适配/幂等 | 869cbd8 |
| kokoro-agent | LordFoxFairy/kokoro-agent | Run、执行、HITL、恢复、事件投影、HTTP ingress | 78639b4 |
...
kokoro-agent 指向 78639b4；其余 9 个目录是同目录独立 checkout，不是 Root 的业务子目录。
