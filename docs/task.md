...
| W1C-2D / P0 | Root真实 HTTPS Web→BFF→IAM RP-only 组合 / `w1c_root_smoke_hardening_sol`唯一Root脚本writer、`w1c_iam_fixture_identity_sol`唯一IAM测试fixture writer，Root审查/Git | 固定Web `bbd8f0806e3c040200af9d478828232baae57ff2`、BFF `2d951e1a56b5720431963d728b74f662e2379999`、IAM `606d9090c2282e13370e17a20379a32629df9722`，均已推送main并由Root `feab1c7…`精确gitlink/库存pin；Root两脚本待提交 | IAM实际三键`code/state/iss`严格验、IAM test fixture预分配UUID+owner marker与SIGKILL定向清理、Root runner两轮审查最终0 P0/P1/P2；Root独立Web1345/Playwright6、IAM verify704+真实PG/Redis13、BFF252/253(1 skip)+真实schema6、Root pytest588/78均PASS。真实HTTPS三服务RP-only **14/14**、自有资源0；旧 IAM→BFF新pin15/15。终态仍受控503无Product Session、旧直连与Product/AG-UI未闭环；Root脚本提交/发布后main-only复验。状态：待集成验证 |
