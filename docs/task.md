...
| W1C-Team-P / P0 | IAM文档新来源→BFF relay机械pin / BFF唯一writer、Root审查/Git | BFF `eb7ded2…`→`1d1f42775e0fa4464de6b08ee9d2b9cd82911a71` 已提交推送main且clean；Web `0e0ec3a…` 已消费；policy字节digest `bbd86696e1b36a82c1ebd35262dba3950a35d56d7d63856df217f397d8b48819` | BFF仅四处来源pin；Node22 policy聚焦4/4、contract check通过；Web已消费pin，Root `594358ba…` 首次集成，后续HTTPS修复gitlink/库存尚待提交。状态：BFF/Web owner已验，Root最终pin待集成 |
