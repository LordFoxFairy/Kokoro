...
| W1C-2 / P0 | Web Auth.js RP、同源adapter与Product Session / Web单仓分片唯一writer；Root审查/Git | Web三文档、2A、2B-1、2B-2及2C RP-only源码已分别发布，最新Web `5299f290ff7653933078007678a2b7a3da01dc67`；BFF `a4dbc333…`/IAM `6bc9b19…`来源固定 | 三页同源交互/CSRF和 Auth.js Code+S256验证已落地；Product Session、全代理Bearer、旧IAM直连删除及真实三服务组合未完成。状态：部分完成，不是登录闭环 |
