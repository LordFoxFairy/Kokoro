...
> **历史需求基线（2026-09-01）**：本文及其“三仓 stream / Session”表述来自阶段 1 原型。当前仓库拓扑、BFF Chat 边界和 PostgreSQL + Redis 运行基线以 [`docs/REPOSITORY_STATUS.md`](../REPOSITORY_STATUS.md) 与阶段 2 契约为准。
