...
状态：2026-09-04，IAM-S1 已实现、独立审查、集成并主仓复验；IAM-S2a 已派工。完整重构验收 goal 仍在进行。
...
| IAM-03 | 按获准业务切片重构，不一次性搬空仓库                          | IAM-02 通过；逐片补齐任务卡 | IAM 负责人     | S1 已合入；S2a 已派工      |
| IAM-04 | 真实依赖、契约、架构与运行验证；评审提交和剩余风险            | 对应实现切片完成            | 主控及独立审查 | S1 已复验，最终验收未完成  |
...
禁止改其他表主键/deleted_at、Proto/generated、依赖/lockfile/CI、整体目录/框架、跨仓功能或管理 API。
