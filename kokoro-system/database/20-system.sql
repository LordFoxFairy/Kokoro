...
CREATE TABLE IF NOT EXISTS system_config_record (
  id CHAR(36) NOT NULL PRIMARY KEY, module_key VARCHAR(64) NOT NULL, scope_type VARCHAR(32) NOT NULL,
  ...
  created_at DATETIME(6) NOT NULL, updated_at DATETIME(6) NOT NULL,
  INDEX system_config_lookup_idx (module_key, scope_type, scope_id, product_id, status, id),
